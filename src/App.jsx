...
function Navbar({ view, setView, onShowAuth }) {
  ...
  // ── FIX: Manejador para desmontar vista de manera forzada al desautenticar ──
        ...
        <div style={{ padding: '0 16px', display: 'flex', alignItems: 'center', height: 56, gap: 8 }}>
          ...
          {!isMobile && user && (
            <div style={{ display: 'flex', alignItems: 'center', gap: 6, flexShrink: 0 }}>
              ...
              <button onClick={handleLogoutClick} style={{ padding: '6px 12px', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 10, background: 'none', color: '#F87171', cursor: 'pointer', fontSize: 12, whiteSpace: 'nowrap' }}>Salir</button>
            </div>
          )}
          {!isMobile && !user && (
          ...
          <div style={{ background: 'rgba(5,10,20,0.98)', borderBottom: '1px solid rgba(255,255,255,0.08)', padding: '8px 0' }} onClick={e => e.stopPropagation()}>
            ...
            {user ? (
              <div style={{ padding: '8px 20px' }}>
                ...
                <button onClick={handleLogoutClick} style={{ width: '100%', padding: '12px', border: '1px solid rgba(248,113,113,0.3)', borderRadius: 10, background: 'rgba(248,113,113,0.08)', color: '#F87171', cursor: 'pointer', fontSize: 15, fontWeight: 600 }}>Cerrar sesion</button>
              </div>
            ) : (
